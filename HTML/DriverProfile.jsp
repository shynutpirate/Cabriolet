...
<div id="mySidenav" class="sidenav">
 ...
 <br>
 <a href="#"><span class="glyphicon glyphicon-user" style="font-size:30px;color:white;"></span> Your Account</a>
 <a></a>
...
<a href="#"><span class="glyphicon glyphicon-credit-card" style="font-size:30px;color:white;"></span> Payment</a>
   <a></a>
<a href="#"><span class="glyphicon glyphicon-list" style="font-size:30px;color:white;"></span> Rides History</a>
</div>
<div id="mySidenav" class="sidenav">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
</div>
            ...
            <div class="well well-sm">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        ...
                        <small><cite title="Hyderabad"> Hyderabad <i class="glyphicon glyphicon-map-marker">
                        </i></cite></small>
                        <p>
                            <i class="glyphicon glyphicon-envelope"></i><%= session.getAttribute("email")%>
                            <br>
                            <i class="glyphicon glyphicon-gift"></i> march 03, 1986</p>
                    </div>
                </div>
            </div>
			</div>
