...
var lat;
    ...
    function initMap() {
     ...
     function openNav() {
      ...
      function TotalCost() {
	       var distance = google.maps.geometry.spherical.computeDistanceBetween(new google.maps.LatLng(plat, plng), new google.maps.LatLng(dlat,dlng));  
   	   var cost;
	      window.alert((distance /1000) * 10);
     }
